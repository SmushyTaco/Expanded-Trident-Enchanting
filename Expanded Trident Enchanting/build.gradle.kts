...
tasks {
    ...
    register<TaskPublishCurseForge>("publishCurseForge") {
        ...
        val file = upload(487100, remapJar)
        file.displayName = "[${project.extra["minecraft_version"] as String}] Expanded Trident Enchanting"
...
modrinth {
    ...
    projectId.set("expanded-trident-enchanting")
    uploadFile.set(tasks.remapJar)
    gameVersions.addAll(project.extra["minecraft_version"] as String)
    versionName.set("[${project.extra["minecraft_version"] as String}] Expanded Trident Enchanting")
    dependencies {
